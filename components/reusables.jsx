...
<span className="bg-linear-to-br from cyan-200 via-cyan-300 to-cyan-500
bg-clip-text text-transparent">{children}</span>
);

export const SectionLabel = ({ children }) => (
  <p className="inline-flex items-center gap-2 text-xs font-semibold text-cyan-300 tracking-[0.14em] uppercase mb-4">
    
    <span className="w-4 h-px bg-cyan-300" />
...
export default function PageHeader({label,gray,blue,description,right}){
  return(
