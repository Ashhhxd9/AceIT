...
import { GravityStarsBackgroundDemo } from './demo-components-backgrounds-stars';
...
export function FeedbackModal({open, onOpenChange, feedback, intervieweeName}) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="bg-black border border-cyan-200/20 text-stone-100 sm:max-w-3xl max-h-[85vh]
        overflow-y-auto">
            ...
            <div className='relative flex flex-col gap-5 mt-2'>
                <div 
                className={`rounded-2xl border ${rating.className} bg-linear-to-br ${rating.bg}
                to-transparent p-6 flex items-center justify-between`}>
                    <div>
                    ...
                    <div className='grid grid-cols-2 gap-3'>
                        <div className='bg-[#141417] border border-white/8 rounded-xl p-5'>
                            <div className='flex items-center gap-2 mb-3'>
                                ...
                                <p className='text-[10px] uppercase tracking-widest text-stone-500'>Strengths</p>
                            </div>
