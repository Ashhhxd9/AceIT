          ...
          >
            ...
            <p
              className={`font-serif text-4xl leading-none tracking-tight ${
                stat.blue
                  ? "bg-linear-to-br from-cyan-300 to-cyan-500 bg-clip-text text-transparent"
            ...
            <>
              <DialogHeader>
                ...
                <DialogDescription className="text-stone-500 text-xs font-light">
                  ...
                  <span className="text-cyan-400">{balance} credits</span> will
                  be withdrawn.
                </DialogDescription>
              </DialogHeader>
              ...
              <div className="flex flex-col gap-5 py-2">
                ...
                <div className="rounded-xl bg-[#141417] border border-white/8 p-4 flex flex-col gap-2">
                  ...
                  <div className="flex justify-between text-sm font-medium">
                    ...
                    <span className="text-cyan-400">${netAmount}</span>
                  </div>
                </div>
