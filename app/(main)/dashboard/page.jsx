      ...
      <PageHeader
        ...
        right={
          <div>
            ...
            <p className="font-serif text-3xl leading-none bg-linear-to-br from-cyan-300 to-cyan-500 bg-clip-text text-transparent text-right">
        ...
        <Tabs defaultValue="earnings">
          <TabsList className="bg-[#0f0f11] border border-white/10 mb-8 w-full">
            <TabsTrigger value="earnings" className="p-5">
              <Wallet size={16} className="text-cyan-400" /> Earnings
            </TabsTrigger>
            ...
            <TabsTrigger value="availability" className="p-5">
              <Clock size={18} className="text-cyan-400" /> Availability
            </TabsTrigger>
          </TabsList>
