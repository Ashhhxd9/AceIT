    ...
    <div className='min-h-screen px-6  flex flex-col items-center'>
      <div className='w-full max-w-2xl'>
        <div className='text-center mb-10'>
            ...
            <h1 className='font-serif text-5xl laeding-tight tracking-tighter mt-1'>
            <GrayTitle>How will you be using</GrayTitle>
            <br/>
            <BlueTitle>AceIT today?</BlueTitle>
</h1>
<p className='text-sm text-stone-500 font-light mt-4 leading-relaxed'>
    This helps us to classify and personalize your experience .
    <span className='text-stone-600'>
      ...
      {!role && (
        <div className='grid grid-cols-2 gap-4 w-full'>
            {ONBOARDING_ROLES.map((r)=>(
                ...
                className='text-left rounded-2xl p-8 border-white/10 bg-[#0f0f11]
                hover:border-cyan-400/20 hover:-translate-y-0.5
                transition-all duration-300'
                >
                    <span className='w-11 h-11 rounded-xl bg-cyan-400/10 border\
                    border-cyan-400/20 flex items-center justify-center text-xl mb-5'>
                        {r.icon}
                    </span>
      ...
      {role && (
        <div className='flex flex-col gap-6'>
            <div className='flex items-center justify-between bg-[#0f0f11] border
            border-white/10 rounded-2xl px-6 py-4'>
                <div className='flex items-center gap-3'>
                    <span className='w-9 h-9 rounded-xl bg-cyan-400/10 border
                    border-cyan-400/20 flex items-center justify-center text-base 
                    shrink-0 '>
                ...
                <Button variant='blue' size='sm' onClick={()=> setRole(null)}>
                    Change 
                </Button>
            </div>
                ...
                <div className='grid grid-cols-2 gap-4'>
                 ...
                 <div className='flex flex-col gap-2'>
                    <Label htmlFor="company">Company</Label>
                        <Input
                        id="company"
                        placeholder="Google,Meta,Nvidia..."
                        value={form.company}
                        onChange={(e)=>
        ...
        :"border-white/10 text-stone-500"
            ...
            {category.label}
                ...
                rows={4}
                maxLength={300}
                placeholder="Introduce yourself to the Interviewees,describing your background,
                what you specialize in, and what can they expect from a session with you"
                value={form.bio}
                onChange={(e)=>
