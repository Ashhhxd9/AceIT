    ...
    <div className="flex flex-col gap-4 h-full overflow-hidden">
      ...
      {questions.length > 0 ? (
          ...
          {questions.map((q, i) => (
            ...
            >
              ...
              <p className="text-xs text-stone-500 font-light leading-relaxed">
                <span className="text-cyan-400/70 font-medium">Answer: </span>
                {q.answer}
              </p>
            </div>
          ))}
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-2 text-center">
          <span className="w-10 h-10 rounded-xl bg-cyan-400/10 border border-cyan-400/20 flex items-center justify-center">
